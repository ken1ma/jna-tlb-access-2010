...
/**
 * <p>uuid({00000565-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{00000565-0000-0010-8000-00AA006D2EA4}")
public interface _Stream_Deprecated extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>id(0xf)</p>
     * <p>vtableId(26)</p>
     * @param DestStream [in] {@code _Stream_Deprecated}
     * @param CharNumber [in, optional] {@code Integer}
     */
    @ComMethod(name = "CopyTo", dispId = 0xf)
    void CopyTo(_Stream_Deprecated DestStream,
            Integer CharNumber);
