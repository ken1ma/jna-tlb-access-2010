...
/**
 * <p>uuid({0000154F-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{0000154F-0000-0010-8000-00AA006D2EA4}")
public interface Recordset20 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1f4)</p>
     * <p>vtableId(7)</p>
     */
    ...
    _Recordset NextRecordset(VARIANT RecordsAffected);
    ...
    _Recordset Clone(LockTypeEnum LockType);
