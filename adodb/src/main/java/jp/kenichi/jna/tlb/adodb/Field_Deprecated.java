...
/**
 * <p>uuid({00000569-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{00000569-0000-0010-8000-00AA006D2EA4}")
public interface Field_Deprecated extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1f4)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(28)</p>
     */
    @ComProperty(name = "Status", dispId = 0x45c)
    Integer getStatus();
