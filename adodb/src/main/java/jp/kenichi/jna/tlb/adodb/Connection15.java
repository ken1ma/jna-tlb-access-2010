...
/**
 * <p>uuid({00001515-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{00001515-0000-0010-8000-00AA006D2EA4}")
public interface Connection15 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1f4)</p>
     * <p>vtableId(7)</p>
     */
