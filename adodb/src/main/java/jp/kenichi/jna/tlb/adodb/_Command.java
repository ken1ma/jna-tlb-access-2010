...
/**
 * <p>uuid({0000154E-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{0000154E-0000-0010-8000-00AA006D2EA4}")
public interface _Command extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x1f4)</p>
     * <p>vtableId(7)</p>
     */
    ...
    _Recordset Execute(VARIANT RecordsAffected,
            Object Parameters,
            Integer Options);
     ...
     * <p>vtableId(24)</p>
     */
    @ComProperty(name = "State", dispId = 0x9)
    Integer getState();
     ...
     * <p>vtableId(25)</p>
     */
    @ComMethod(name = "Cancel", dispId = 0xa)
    void Cancel();
