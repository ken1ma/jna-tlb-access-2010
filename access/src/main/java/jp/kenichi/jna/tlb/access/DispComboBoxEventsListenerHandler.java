 ...
 */
public abstract class DispComboBoxEventsListenerHandler extends AbstractComEventCallbackListener implements DispComboBoxEventsListener {
    @Override
     ...
     */
    @Override
    public void NotInList(VARIANT NewData,
            VARIANT Response){
    }
