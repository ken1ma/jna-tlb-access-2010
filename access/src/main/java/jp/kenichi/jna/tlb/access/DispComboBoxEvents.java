...
/**
 * <p>uuid({2E705276-92D1-43CC-A57B-ED48BCCC711D})</p>
 */
@ComInterface(iid="{2E705276-92D1-43CC-A57B-ED48BCCC711D}")
public interface DispComboBoxEvents extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x80d)</p>
    ...
    /**
     * <p>id(0x81e)</p>
     * @param NewData [inout] {@code String}
     * @param Response [out] {@code Short}
     */
    @ComMethod(name = "NotInList", dispId = 0x81e)
    void NotInList(VARIANT NewData,
            VARIANT Response);
