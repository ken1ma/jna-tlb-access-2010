 ...
 */
@ComInterface(iid="{3B06E981-E47C-11CD-8701-00AA003F0F07}")
public interface DispAttachmentEvents extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x80d)</p>
     ...
     * <p>id(0x9b3)</p>
     */
    @ComMethod(name = "AttachmentCurrent", dispId = 0x9b3)
