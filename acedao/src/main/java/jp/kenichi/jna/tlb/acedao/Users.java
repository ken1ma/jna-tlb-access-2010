...
/**
 * <p>uuid({0000006B-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{0000006B-0000-0010-8000-00AA006D2EA4}")
public interface Users extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     */
