...
/**
 * <p>uuid({00000063-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{00000063-0000-0010-8000-00AA006D2EA4}")
public interface Groups extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     */
