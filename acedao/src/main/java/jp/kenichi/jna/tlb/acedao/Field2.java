...
/**
 * <p>uuid({00000054-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{00000054-0000-0010-8000-00AA006D2EA4}")
public interface Field2 extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xa)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(46)</p>
     */
    @ComProperty(name = "ComplexType", dispId = 0x60040000)
     ...
     */
    @ComMethod(name = "LoadFromFile", dispId = 0x60040001)
     ...
     * @param FileName [in] {@code String}
     */
    @ComMethod(name = "SaveToFile", dispId = 0x60040002)
     ...
     * <p>vtableId(49)</p>
     */
    @ComProperty(name = "IsComplex", dispId = 0x60040003)
     ...
     * <p>vtableId(50)</p>
     */
    @ComProperty(name = "AppendOnly", dispId = 0x60040004)
     ...
     */
    @ComProperty(name = "AppendOnly", dispId = 0x60040004)
    void setAppendOnly(Boolean param0);
            
    /**
     * <p>id(0x60040006)</p>
     * <p>vtableId(52)</p>
     */
    @ComProperty(name = "Expression", dispId = 0x60040006)
     ...
     */
    @ComProperty(name = "Expression", dispId = 0x60040006)
    void setExpression(String param0);
