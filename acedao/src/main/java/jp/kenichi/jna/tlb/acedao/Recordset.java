...
/**
 * <p>uuid({00000031-0000-0010-8000-00AA006D2EA4})</p>
 */
@ComInterface(iid="{00000031-0000-0010-8000-00AA006D2EA4}")
public interface Recordset extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xa)</p>
     * <p>vtableId(7)</p>
     */
