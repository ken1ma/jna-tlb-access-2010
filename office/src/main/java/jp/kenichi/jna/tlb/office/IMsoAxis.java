...
/**
 * <p>uuid({000C1713-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C1713-0000-0000-C000-000000000046}")
public interface IMsoAxis extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(86)</p>
     */
    @ComProperty(name = "Name", dispId = 0x6002004f)
    String getName();
