...
/**
 * <p>uuid({000C170F-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C170F-0000-0000-C000-000000000046}")
public interface IMsoChartTitle extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x60020000)</p>
     * <p>vtableId(7)</p>
