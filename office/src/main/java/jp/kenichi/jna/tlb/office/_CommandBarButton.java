...
/**
 * <p>uuid({000C030E-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C030E-0000-0000-C000-000000000046}")
public interface _CommandBarButton extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xffffec78)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(83)</p>
     */
    @ComProperty(name = "BuiltInFace", dispId = 0x60050000)
     ...
     * <p>vtableId(85)</p>
     */
    @ComMethod(name = "CopyFace", dispId = 0x60050002)
    void CopyFace();
     ...
     * <p>vtableId(86)</p>
     */
    @ComProperty(name = "FaceId", dispId = 0x60050003)
    Integer getFaceId();
     ...
     */
    @ComProperty(name = "FaceId", dispId = 0x60050003)
    void setFaceId(Integer param0);
            
    /**
     * <p>id(0x60050005)</p>
     * <p>vtableId(88)</p>
     */
    @ComMethod(name = "PasteFace", dispId = 0x60050005)
    void PasteFace();
     ...
     * <p>vtableId(89)</p>
     */
    @ComProperty(name = "ShortcutText", dispId = 0x60050006)
     ...
     */
    @ComProperty(name = "ShortcutText", dispId = 0x60050006)
    void setShortcutText(String param0);
            
    /**
     * <p>id(0x60050008)</p>
     * <p>vtableId(91)</p>
     */
    @ComProperty(name = "State", dispId = 0x60050008)
    MsoButtonState getState();
            
    /**
     * <p>id(0x60050008)</p>
     * <p>vtableId(92)</p>
     * @param param0 [in] {@code MsoButtonState}
     */
    @ComProperty(name = "State", dispId = 0x60050008)
    void setState(MsoButtonState param0);
            
    /**
     * <p>id(0x6005000a)</p>
     * <p>vtableId(93)</p>
     */
    @ComProperty(name = "Style", dispId = 0x6005000a)
    MsoButtonStyle getStyle();
            
    /**
     * <p>id(0x6005000a)</p>
     * <p>vtableId(94)</p>
     * @param param0 [in] {@code MsoButtonStyle}
     */
    @ComProperty(name = "Style", dispId = 0x6005000a)
    void setStyle(MsoButtonStyle param0);
            
    /**
     * <p>id(0x6005000c)</p>
     * <p>vtableId(95)</p>
     */
    @ComProperty(name = "HyperlinkType", dispId = 0x6005000c)
    MsoCommandBarButtonHyperlinkType getHyperlinkType();
            
    /**
     * <p>id(0x6005000c)</p>
     * <p>vtableId(96)</p>
     * @param param0 [in] {@code MsoCommandBarButtonHyperlinkType}
     */
    @ComProperty(name = "HyperlinkType", dispId = 0x6005000c)
    void setHyperlinkType(MsoCommandBarButtonHyperlinkType param0);
            
    /**
     * <p>id(0x6005000e)</p>
     * <p>vtableId(97)</p>
     */
    @ComProperty(name = "Picture", dispId = 0x6005000e)
    jp.kenichi.jna.tlb.stdole.Picture getPicture();
            
    /**
     * <p>id(0x6005000e)</p>
     * <p>vtableId(98)</p>
     * @param param0 [in] {@code jp.kenichi.jna.tlb.stdole.Picture}
     */
    @ComProperty(name = "Picture", dispId = 0x6005000e)
    void setPicture(jp.kenichi.jna.tlb.stdole.Picture param0);
            
    /**
     * <p>id(0x60050010)</p>
     * <p>vtableId(99)</p>
     */
    @ComProperty(name = "Mask", dispId = 0x60050010)
    jp.kenichi.jna.tlb.stdole.Picture getMask();
     ...
     */
    @ComProperty(name = "Mask", dispId = 0x60050010)
    void setMask(jp.kenichi.jna.tlb.stdole.Picture param0);
            
    /**
     * <p>id(0x60050012)</p>
     * <p>vtableId(101)</p>
     */
    @ComProperty(name = "InstanceIdPtr", dispId = 0x60050012)
