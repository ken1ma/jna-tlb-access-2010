...
/**
 * <p>uuid({000C170D-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C170D-0000-0000-C000-000000000046}")
public interface Points extends IUnknown, IRawDispatchHandle, IDispatch {
     ...
     * @param RHS [out] {@code ChartPoint}
     */
    @ComMethod(name = "Item", dispId = 0xaa)
    com.sun.jna.platform.win32.WinNT.HRESULT Item(Integer Index,
            VARIANT RHS);
