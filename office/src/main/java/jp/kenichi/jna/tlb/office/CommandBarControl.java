...
/**
 * <p>uuid({000C0308-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C0308-0000-0000-C000-000000000046}")
public interface CommandBarControl extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xffffec78)</p>
     * <p>vtableId(7)</p>
     */
