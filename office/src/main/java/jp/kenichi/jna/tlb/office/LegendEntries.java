...
/**
 * <p>uuid({000C1719-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C1719-0000-0000-C000-000000000046}")
public interface LegendEntries extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x96)</p>
     * <p>vtableId(7)</p>
     ...
     * @param RHS [out] {@code LegendEntry}
     */
