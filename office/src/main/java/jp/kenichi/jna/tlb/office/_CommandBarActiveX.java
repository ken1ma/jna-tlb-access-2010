...
/**
 * <p>uuid({000C030D-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C030D-0000-0000-C000-000000000046}")
public interface _CommandBarActiveX extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xffffec78)</p>
     * <p>vtableId(7)</p>
     */
     ...
     * <p>vtableId(83)</p>
     */
    @ComProperty(name = "ControlCLSID", dispId = 0x60050000)
    String getControlCLSID();
     ...
     */
    @ComProperty(name = "ControlCLSID", dispId = 0x60050000)
    void setControlCLSID(String param0);
            
    /**
     * <p>id(0x60050002)</p>
     * <p>vtableId(85)</p>
     * @param bstrIid [in] {@code String}
     */
    @ComProperty(name = "QueryControlInterface", dispId = 0x60050002)
    com.sun.jna.platform.win32.COM.util.IUnknown getQueryControlInterface(String bstrIid);
     ...
     */
    @ComMethod(name = "SetInnerObjectFactory", dispId = 0x60050003)
    void SetInnerObjectFactory(com.sun.jna.platform.win32.COM.util.IUnknown pUnk);
            
    /**
     * <p>id(0x60050004)</p>
     * <p>vtableId(87)</p>
     */
    @ComMethod(name = "EnsureControl", dispId = 0x60050004)
    void EnsureControl();
     ...
     */
    @ComProperty(name = "InitWith", dispId = 0x60050005)
    void setInitWith(com.sun.jna.platform.win32.COM.util.IUnknown param0);
            
    /**
     * <p>id(0x60050006)</p>
     * <p>vtableId(89)</p>
     */
    @ComProperty(name = "InstanceIdPtr", dispId = 0x60050006)
