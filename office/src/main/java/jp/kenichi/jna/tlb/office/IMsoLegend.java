...
/**
 * <p>uuid({000C1710-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C1710-0000-0000-C000-000000000046}")
public interface IMsoLegend extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x96)</p>
     * <p>vtableId(7)</p>
     */
