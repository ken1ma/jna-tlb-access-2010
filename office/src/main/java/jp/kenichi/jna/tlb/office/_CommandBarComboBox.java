...
/**
 * <p>uuid({000C030C-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C030C-0000-0000-C000-000000000046}")
public interface _CommandBarComboBox extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0xffffec78)</p>
     * <p>vtableId(7)</p>
     */
     ...
     */
    @ComMethod(name = "AddItem", dispId = 0x60050000)
     ...
     * <p>vtableId(84)</p>
     */
    @ComMethod(name = "Clear", dispId = 0x60050001)
    void Clear();
     ...
     * <p>vtableId(85)</p>
     */
    @ComProperty(name = "DropDownLines", dispId = 0x60050002)
     ...
     * <p>vtableId(87)</p>
     */
    @ComProperty(name = "DropDownWidth", dispId = 0x60050004)
    Integer getDropDownWidth();
     ...
     */
    @ComProperty(name = "DropDownWidth", dispId = 0x60050004)
    void setDropDownWidth(Integer param0);
     ...
     */
    @ComProperty(name = "List", dispId = 0x60050006)
    String getList(Integer Index);
     ...
     * <p>vtableId(91)</p>
     */
    @ComProperty(name = "ListCount", dispId = 0x60050008)
     ...
     * <p>vtableId(92)</p>
     */
    @ComProperty(name = "ListHeaderCount", dispId = 0x60050009)
    Integer getListHeaderCount();
     ...
     */
    @ComProperty(name = "ListHeaderCount", dispId = 0x60050009)
    void setListHeaderCount(Integer param0);
            
    /**
     * <p>id(0x6005000b)</p>
     * <p>vtableId(94)</p>
     */
    @ComProperty(name = "ListIndex", dispId = 0x6005000b)
     ...
     * @param Index [in] {@code Integer}
     */
    @ComMethod(name = "RemoveItem", dispId = 0x6005000d)
     ...
     * <p>vtableId(97)</p>
     */
    @ComProperty(name = "Style", dispId = 0x6005000e)
    MsoComboStyle getStyle();
            
    /**
     * <p>id(0x6005000e)</p>
     * <p>vtableId(98)</p>
     * @param param0 [in] {@code MsoComboStyle}
     */
    @ComProperty(name = "Style", dispId = 0x6005000e)
    void setStyle(MsoComboStyle param0);
            
    /**
     * <p>id(0x60050010)</p>
     * <p>vtableId(99)</p>
     */
    @ComProperty(name = "Text", dispId = 0x60050010)
    String getText();
