...
/**
 * <p>uuid({000C171F-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C171F-0000-0000-C000-000000000046}")
public interface IMsoDataLabels extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x96)</p>
     * <p>vtableId(7)</p>
     ...
     * @param RHS [out] {@code IMsoCharacters}
     */
    @ComProperty(name = "Characters", dispId = 0x60020007)
