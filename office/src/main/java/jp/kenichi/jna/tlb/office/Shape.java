...
/**
 * <p>uuid({000C031C-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C031C-0000-0000-C000-000000000046}")
public interface Shape extends IUnknown, IRawDispatchHandle, IDispatch {
     ...
     * <p>id(0x9d)</p>
     * <p>vtableId(94)</p>
     * @param Layout [in] {@code SmartArtLayout}
     */
    @ComMethod(name = "ConvertTextToSmartArt", dispId = 0x9d)
