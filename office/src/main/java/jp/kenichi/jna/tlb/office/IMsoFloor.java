...
/**
 * <p>uuid({000C1716-0000-0000-C000-000000000046})</p>
 */
@ComInterface(iid="{000C1716-0000-0000-C000-000000000046}")
public interface IMsoFloor extends IUnknown, IRawDispatchHandle, IDispatch {
    /**
     * <p>id(0x6e)</p>
     * <p>vtableId(7)</p>
     */
